...
/* 7055 and 7058 differ at least in these regards :
 * - HCAN registers (different peripheral, regs and base addr)
 * - MTAD peripheral only on 7058
 * - SYSCR / MSTCR regs
 * - some PxPR (IO port register, to read pin state) regs only on 7058
 */
